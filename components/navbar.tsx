...
export const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      {/* Main Navbar */}
      <div className={`w-full transition-all duration-300 ${scrolled ? 'backdrop-blur-sm bg-white/90 dark:bg-gray-900/90 border-b border-gray-200 dark:border-gray-700' : 'bg-transparent'
        }`}>
